...
class CanvasDemo:
    def __init__(self):
        ...
        btPloygon = Button(frame, text="Ploygon", command=self.displayPolygon )
    ...
    def displayRect(self):
        self.canvas.create_rectangle(10, 40, 190, 90, tags="rect")
    ...
    def displayString(self):
        self.canvas.create_text(60, 40, text="Hi, I am a string",
                                font="Time 10 bold underline", tags="string")
